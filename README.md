...
This library is a mix of the Arduino-HMC5883L library for Arduino from Github, and a Proof of concept Arduino library, 
for the HMC5983 device. And ofcourse the Datasheet you can find here:
